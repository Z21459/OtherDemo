...
--		print("split",split,i)
	...
	if flag == 1 then
		print("resultsplit",split)--
		table.insert(temcmd,split) --¿¿¿¿¿¿¿¿¿¿¿
		flag = 0
	end
	return split,value
end
...
--		print("debug")
	...
	elseif (ret[3]== "i" and ret[1] == "debuginject") then
		print("inejct")
		command = "inject"
	elseif (ret[3]== "di" and ret[1] == "debuginject") then
		command = "debuginject"
	else
		command = split[1]
		print(command)
...
--  debuginject address etype filename
--
--	print("docmd_command",command) --command
...
--	local cmd ,ret= split_cmdline(temcmd[2])
...
--sure cmd  and resultsplit equal
...
--			print("cmdfd1",cmd.fd)
	...
	print("cdmfd2address",address,cmd.fd)--8 2
